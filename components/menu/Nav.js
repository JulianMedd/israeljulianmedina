...
export const Nav = ({open, isOpen}) => {
    ...
    return(
        <nav className={`w-4/5 h-screen fixed top-0 ${ open ? 'left-0 ' : '-left-full'} md:left-0 md:w-60 z-50 bg-indigo-200 py-14 pl-18 md:pl-2 pr-6 flex items-center justify-evenly duration-700`}>
            ...
            <h2 
                className="textRotate text-gray-400 font-thin tracking-widest cursor-pointer"
                onClick={() => router.push('/')}
            >
