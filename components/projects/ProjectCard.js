...
const ProjectCard = ({ name, description, url, tools }) => {
    return (
        <div className='card group w-56 rounded-md'>
            <div className='w-full h-16 px-4 pt-2 text-white rounded-t-md bg-indigo-400 md:bg-gray-300 group-hover:bg-indigo-400 '>
